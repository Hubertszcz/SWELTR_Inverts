...
Contrary to finding from higher lattitude warming experiments, total soil and litter fauna in the warmed plots was actually greater than in control plots.
...
While most taxa decreased in abundance, a few (notably Oribatida, the most abundant taxon), increased on warmed plots. See trends for individual taxa here:

## Insects

```{r, echo=FALSE, message = FALSE, warning = FALSE}
soil.abundance3 <- read.csv("soil.abundance3.csv")
...
```{r, echo=FALSE, message = FALSE, warning = FALSE}
litter.abundance3 <- read.csv("soil.abundance3.csv")
